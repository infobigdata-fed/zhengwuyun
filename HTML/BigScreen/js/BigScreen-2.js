$(function() {
	...
	var twocityFn = function() {
		...
		$('#City-2 g').each(function(i) {
			if(liuru_1[i] != undefined) {
				$(this).attr("transform", "translate(80,-" + liuru_1[i]['value']*0.03 + ")");
		...
		$('#City g').each(function(i) {
			if(liuchu_1[i] != undefined) {
				$(this).attr("transform", "translate(80," + liuchu_1[i]['value']*0.006 + ")");
		...
		$('#City-3 g').each(function(i) {
			if(liuchu_2[i] != undefined) {
				$(this).attr("transform", "translate(80,-" + liuchu_2[i]['value']*0.02 + ")");
		...
		$('#City-4 g').each(function(i) {
			if(liuru_2[i] != undefined) {
				$(this).attr("transform", "translate(80," + liuru_2[i]['value']*0.006 + ")");
		...
		line_2_t = 542 + chengshi_2.liuruH * 0.5 - line_1_v * 0.5;
		$('#Line-20-s').attr({
	...
	var _data = JSON.parse($('#data').val());
	chengshi_1 = _data[0];
	liuru_1=_data[0].import=[];
	liuchu_1=_data[0].export=[];
	chengshi_2 = _data[1];
	liuru_2=_data[1].import=[];
	liuchu_2=_data[1].export=[];

	if(chengshi_1.liuru * xianshibi > 150) {
		if(chengshi_1.liuru * xianshibi > 378) {
			chengshi_1.liuruH = 378
		} else {
	...
	if(chengshi_1.liuchu * xianshibi > 150) {
		if(chengshi_1.liuchu * xianshibi > 220) {
			chengshi_1.liuchuH = 220
		} else {
	...
	if(chengshi_2.liuru * xianshibi > 150) {
		if(chengshi_2.liuru * xianshibi > 300) {
			chengshi_2.liuruH = 300
		} else {
	...
	if(chengshi_2.liuchu * xianshibi > 150) {
		if(chengshi_2.liuchu * xianshibi > 280){
			chengshi_2.liuchuH=280
		}else{
